...
dd = read.csv("result/ECCR/ECCR_curve.csv",header=TRUE)
...
#Linear
pdf(file = 'result/ECCR/Linear_fits.pdf', width =8.5, height=5, onefile=T)
...
write.csv(modelfitting_results, file = "result/ECCR/Linear_fits.csv")
...
pdf(file = 'result/ECCR/Logistic_fits.pdf', width =8.5, height=5, onefile=T)
...
write.csv(modelfitting_results, file = "result/ECCR/Logistic_fits.csv")
cat("Logistic has ", length(problem_rows), "curve(s) with NAs: ", problem_rows)


#Sigmoidal
#Declare the pdf file to hold the plots
pdf(file = 'result/ECCR/Sigmoidal_fits.pdf', width =8.5, height=5, onefile=T)
...
which(is.na(as.numeric(modelfitting_results[,12]))=='TRUE' | is.na(as.numeric(modelfitting_results[,13]))=='TRUE'| is.na(as.numeric(modelfitting_results[,14]))=='TRUE'| is.na(as.numeric(modelfitting_results[,15]))=='TRUE') -> problem_rows
write.csv(modelfitting_results, file = "result/ECCR/Sigmoidal_fits.csv")
cat("Sigmoidal has ", length(problem_rows), "curve(s) with NAs: ", problem_rows)

#Exponential
pdf(file = 'result/ECCR/Exponential_fits.pdf', width =8.5, height=5, onefile=T)
modelfitting_results[FALSE,] -> modelfitting_results
for (ii in 1:length(species_list)){
  subset(dd, dd$to_split == species_list[ii], select =c(1:5)) -> data_by_sp
...
which(is.na(as.numeric(modelfitting_results[,12]))=='TRUE' | is.na(as.numeric(modelfitting_results[,13]))=='TRUE'| is.na(as.numeric(modelfitting_results[,14]))=='TRUE') -> problem_rows
write.csv(modelfitting_results, file = "result/ECCR/Exponential_fits.csv")
cat("Exponential has ", length(problem_rows), "curve(s) with NAs: ", problem_rows)

#Exponential2
pdf(file = 'result/ECCR/Exponential2_fits.pdf', width =8.5, height=5, onefile=T)
modelfitting_results[FALSE,] -> modelfitting_results
for (ii in 1:length(species_list)){
  subset(dd, dd$to_split == species_list[ii], select =c(1:5)) -> data_by_sp
...
which(is.na(as.numeric(modelfitting_results[,12]))=='TRUE' | is.na(as.numeric(modelfitting_results[,13]))=='TRUE'| is.na(as.numeric(modelfitting_results[,14]))=='TRUE') -> problem_rows
write.csv(modelfitting_results, file = "result/ECCR/Exponential2_fits.csv")
