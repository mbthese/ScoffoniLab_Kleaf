...
CESE_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "CESE")
...
psi_kleaf20.cese<- CESE_logistic$C.Xo*(1/0.8-1)^(1/CESE_logistic$B.B)
psi_kleaf50.cese<- CESE_logistic$C.Xo*(1/0.5-1)^(1/CESE_logistic$B.B)#basically only C.Xo but should be the inflection point of th ecurve?
psi_kleaf80.cese<- CESE_logistic$C.Xo*(1/0.2-1)^(1/CESE_logistic$B.B)
psi_kleaf95.cese<- CESE_logistic$C.Xo*(1/0.05-1)^(1/CESE_logistic$B.B)
Kmax.cese<- CESE_logistic$A.A
...
geom_line(aes(x = x_seq.CESE, y = y_model.CESE), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)+
   geom_vline(xintercept = psi_kleaf50.cese, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.cese), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
...
PADI_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "PADI")
...
psi_kleaf50.PADI <- log(0.5)/(-PADI_exp$B.B)

Kmax.PADI<-PADI_exp$A.A
psi_kleaf20.PADI<- log(0.8)/(-PADI_exp$B.B)
psi_kleaf80.PADI<- log(0.2)/(-PADI_exp$B.B)
psi_kleaf95.PADI<- log(0.05)/(-PADI_exp$B.B)
...
geom_vline(xintercept = psi_kleaf50.PADI, linetype ="dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.PADI), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
#+
...
AVSA_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "AVSA")
...
# Calculate Ψleaf at 50% loss of Kleaf
Kmax.AVSA<-AVSA_exp$A.A
psi_kleaf20.AVSA<- log(0.8)/(-AVSA_exp$B.B)
psi_kleaf50.AVSA <- log(0.5)/(-AVSA_exp$B.B)
psi_kleaf80.AVSA<- log(0.2)/(-AVSA_exp$B.B)
psi_kleaf95.AVSA<- log(0.05)/(-AVSA_exp$B.B)
...
geom_line(aes(x = x_seq.AVSA, y = y_model.AVSA), color = 'black', size=2, alpha=0.7)+
 # ylim(0,25)+
   geom_vline(xintercept = psi_kleaf50.AVSA, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.AVSA), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
AVSA.plot 
```
...
STDE_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "STDE")
...
psi_kleaf20.STDE<- STDE_logistic$C.Xo*(1/0.8-1)^(1/STDE_logistic$B.B)
psi_kleaf50.STDE<- STDE_logistic$C.Xo*(1/0.5-1)^(1/STDE_logistic$B.B)#basically only C.Xo but should be the inflection point of th ecurve?
psi_kleaf80.STDE<- STDE_logistic$C.Xo*(1/0.2-1)^(1/STDE_logistic$B.B)
psi_kleaf95.STDE<- STDE_logistic$C.Xo*(1/0.05-1)^(1/STDE_logistic$B.B)
Kmax.STDE<- STDE_logistic$A.A
```
...
geom_line(aes(x = x_seq.STDE, y = y_model.STDE), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)
   geom_vline(xintercept =psi_kleaf50.STDE, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.STDE), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
...
DASP_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "DASP")
...
Kmax.DASP<-DASP_exp$A.A
psi_kleaf20.DASP<- log(0.8)/(-DASP_exp$B.B)
psi_kleaf50.DASP <- log(0.5)/(-DASP_exp$B.B)
psi_kleaf80.DASP<- log(0.2)/(-DASP_exp$B.B)
psi_kleaf95.DASP<- log(0.05)/(-DASP_exp$B.B)
```
...
geom_line(aes(x = x_seq.DASP, y = y_model.DASP), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)+
   geom_vline(xintercept = psi_kleaf50.DASP, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.DASP), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
DASP.plot
```
...
CHLA_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "CHLA")
...
psi_kleaf20.CHLA<- CHLA_logistic$C.Xo*(1/0.8-1)^(1/CHLA_logistic$B.B)
psi_kleaf50.CHLA<- CHLA_logistic$C.Xo*(1/0.5-1)^(1/CHLA_logistic$B.B)#basically only C.Xo but should be the inflection point of th ecurve?
psi_kleaf80.CHLA<- CHLA_logistic$C.Xo*(1/0.2-1)^(1/CHLA_logistic$B.B)
psi_kleaf95.CHLA<- CHLA_logistic$C.Xo*(1/0.05-1)^(1/CHLA_logistic$B.B)
Kmax.CHLA<- CHLA_logistic$A.A
...
geom_line(aes(x = x_seq.CHLA, y = y_model.CHLA), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)
 geom_vline(xintercept = psi_kleaf50.CHLA, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.CHLA), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
   #annotate(geom='text',x=0.5,y=30,label="y = 37.95 * exp(-3.57 x)",fontface='bold', size=6)
...
ZEMA_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "ZEMA")
```
...
# Calculate Ψleaf at 50% loss of Kleaf
Kmax.ZEMA<-ZEMA_exp$A.A
psi_kleaf20.ZEMA<- log(0.8)/(-ZEMA_exp$B.B)
psi_kleaf50.ZEMA <- log(0.5)/(-ZEMA_exp$B.B)
psi_kleaf80.ZEMA<- log(0.2)/(-ZEMA_exp$B.B)
psi_kleaf95.ZEMA<- log(0.05)/(-ZEMA_exp$B.B)
```
...
geom_line(aes(x = x_seq.ZEMA, y = y_model.ZEMA), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)+
   geom_vline(xintercept = psi_kleaf50.ZEMA, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.ZEMA), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
   #annotate(geom='text',x=0.5,y=30,label="y = 37.95 * exp(-3.57 x)",fontface='bold', size=6)
ZEMA.plot
```
...
NAVI_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "NAVI")
...
psi_kleaf20.NAVI<- NAVI_logistic$C.Xo*(1/0.8-1)^(1/NAVI_logistic$B.B)
psi_kleaf50.NAVI<- NAVI_logistic$C.Xo*(1/0.5-1)^(1/NAVI_logistic$B.B)#basically only C.Xo but should be the inflection point of th ecurve?
psi_kleaf80.NAVI<- NAVI_logistic$C.Xo*(1/0.2-1)^(1/NAVI_logistic$B.B)
psi_kleaf95.NAVI<- NAVI_logistic$C.Xo*(1/0.05-1)^(1/NAVI_logistic$B.B)
Kmax.NAVI<- NAVI_logistic$A.A
...
geom_line(aes(x = x_seq.NAVI, y = y_model.NAVI), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)
   geom_vline(xintercept = psi_kleaf50.NAVI, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.NAVI), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
   #annotate(geom='text',x=0.5,y=30,label="y = 37.95 * exp(-3.57 x)",fontface='bold', size=6)
...
PABI_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "PABI")
...
psi_kleaf20.PABI<- PABI_logistic$C.Xo*(1/0.8-1)^(1/PABI_logistic$B.B)
psi_kleaf50.PABI<- PABI_logistic$C.Xo*(1/0.5-1)^(1/PABI_logistic$B.B)#basically only C.Xo but should be the inflection point of th ecurve?
psi_kleaf80.PABI<- PABI_logistic$C.Xo*(1/0.2-1)^(1/PABI_logistic$B.B)
psi_kleaf95.PABI<- PABI_logistic$C.Xo*(1/0.05-1)^(1/PABI_logistic$B.B)
Kmax.PABI<- PABI_logistic$A.A
```
...
geom_line(aes(x = x_seq.PABI, y = y_model.PABI), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)+
   geom_vline(xintercept = psi_kleaf50.PABI, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.PABI), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
   #annotate(geom='text',x=0.5,y=30,label="y = 37.95 * exp(-3.57 x)",fontface='bold', size=6)
PABI.plot
...
ECCR_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "ECCR")
...
dim(ECCR_Kleaf)
#[1] 22 31
 ECCR_Kleaf_clean <- ECCR_Kleaf %>% 
  filter(Specie == "ECCR") %>%
   drop_na(`Psileaf_fin (Mpa)`) %>%
   drop_na(`Kleaf Tcorr (mmol m-2 s-1 MPa-1)`)
  # filter(`Psileaf_fin (Mpa)` != 0.765)
dim(ECCR_Kleaf_clean)
...
write.csv(x = ECCR_curve, file = "result/ECCR/ECCR_curve.csv") #ready for 

#after fitting curve with "Closure Script 2017" and "R function MB 2017"

ECCR_linear <-  read.csv("result/ECCR/Linear_fits.csv") %>%
  mutate(`function` = "linear") %>%
  relocate(`function`, .before = Species) %>%
  dplyr::select(-X) %>%
  rename(species= data.type, Data.type = Species) %>%
...
ECCR_logistic <-  read.csv("result/ECCR/Logistic_fits.csv") %>%
  mutate(`function` = "logistic") %>%
  relocate(`function`, .before = Species) %>%
  dplyr::select(-X) %>%
  rename(species= data.type, Data.type = Species) %>%
...
ECCR_sigmoidal <-  read.csv("result/ECCR/Sigmoidal_fits.csv") %>%
  mutate(`function` = "sigmoidal") %>%
  relocate(`function`, .before = Species) %>%
  dplyr::select(-X) %>%
  rename(species= data.type, Data.type = Species) %>%
...
ECCR_exp <-  read.csv("result/ECCR/Exponential_fits.csv") %>%
  mutate(`function` = "exp") %>%
  relocate(`function`, .before = Species) %>%
  dplyr::select(-X) %>%
  rename(species= data.type, Data.type = Species) %>%
...
ECCR_exp2 <-  read.csv("result/ECCR/Exponential2_fits.csv") %>%
  mutate(`function` = "exp2") %>%
  relocate(`function`, .before = Species) %>%
  dplyr::select(-X) %>%
  rename(species= data.type, Data.type = Species) %>%
...
choose_model <- rbind(ECCR_linear, ECCR_logistic, ECCR_sigmoidal, ECCR_exp, ECCR_exp2)
choose_model 
#best model is the one with the lowest AIC. if models have AIC within 2 points, then we cannot distinguish them. so we look at the highest R2. 
...
# Create a sequence of x values for the regression line from excel
x_seq.ECCR <- seq(min(ECCR_Kleaf_clean$`Lowest Psileaf (Mpa)`), max(ECCR_Kleaf_clean$`Lowest Psileaf (Mpa)`), length.out = length(ECCR_Kleaf_clean$`Lowest Psileaf (Mpa)`))

y_model.ECCR <- ECCR_exp$A.A*exp(-ECCR_exp$B.B*x_seq.ECCR)

# Calculate Ψleaf at 50% loss of Kleaf

Kmax.ECCR<-ECCR_exp$A.A
psi_kleaf20.ECCR<- log(0.8)/(-ECCR_exp$B.B)
psi_kleaf50.ECCR <- log(0.5)/(-ECCR_exp$B.B)
psi_kleaf80.ECCR<- log(0.2)/(-ECCR_exp$B.B)
psi_kleaf95.ECCR<- log(0.05)/(-ECCR_exp$B.B)
```

##plot
```{r}
ECCR_Kleaf_clean$Individual <- as.factor(ECCR_Kleaf_clean$Individual)
ECCR_Kleaf_clean$Light <- as.factor(ECCR_Kleaf_clean$Light)

ECCR.plot <- ECCR_Kleaf_clean %>%
 #filter(Date == "11272024") %>%
  ggplot()+
  aes(x=`Lowest Psileaf (Mpa)`, y=`Kleaf Tcorr (mmol m-2 s-1 MPa-1)`, color=Light)+
  geom_point(size= 3, alpha = 0.7)+
  ...
  theme(axis.title.x = element_blank())+
  theme(axis.title.y = element_blank())+
geom_line(aes(x = x_seq.ECCR, y = y_model.ECCR), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)
  geom_vline(xintercept = psi_kleaf50.ECCR, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.ECCR), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
   #annotate(geom='text',x=0.5,y=30,label="y = 37.95 * exp(-3.57 x)",fontface='bold', size=6)
...
SEIT_Kleaf <-  read_excel("data/Kleaf_data.xlsx", sheet = "SEIT")
...
psi_kleaf20.SEIT<- SEIT_logistic$C.Xo*(1/0.8-1)^(1/SEIT_logistic$B.B)
psi_kleaf50.SEIT<- SEIT_logistic$C.Xo*(1/0.5-1)^(1/SEIT_logistic$B.B)#basically only C.Xo but should be the inflection point of th ecurve?
psi_kleaf80.SEIT<- SEIT_logistic$C.Xo*(1/0.2-1)^(1/SEIT_logistic$B.B)
psi_kleaf95.SEIT<- SEIT_logistic$C.Xo*(1/0.05-1)^(1/SEIT_logistic$B.B)
Kmax.SEIT<- SEIT_logistic$A.A
...
geom_line(aes(x = x_seq.SEIT, y = y_model.SEIT), color = 'black', size=2, alpha=0.7)+
  #ylim(0,25)+
   geom_vline(xintercept = psi_kleaf50.SEIT, linetype = "dashed", color = 'orange')+
  geom_point(aes(x = 0, y = Kmax.SEIT), color = "blue", size = 4) #Zailaa et al. 2024 "The blue extrapolated point in each panel represents the Kmax or gmax values at −0.1 MPa"
   #annotate(geom='text',x=0.5,y=30,label="y = 37.95 * exp(-3.57 x)",fontface='bold', size=6)
SEIT.plot 
```
