...
STDE.plot, DASP.plot, CHLA.plot, ZEMA.plot, nrow=3, ncol=3, labels = c("(a) C. setaceus", "(b) P. dilatatum", "(c) A. sativa", "(d) S. decipiens", "(e) D. spicata", "(f) C. latifolium", "(g) Z. mays "), font.label = list(face="bold.italic"), align = "v")
...
x_filtered.ZEMA <- x_seq.ZEMA[x_seq.ZEMA <= 0.3 & x_seq.ZEMA >= 0]
